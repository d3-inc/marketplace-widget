...
const WidgetLayout = () => {
  ...
  return (
    <div
      className={
        'flex flex-col w-[94svw] h-full max-h-[calc(90dvh)] md:max-h-[560px] max-w-[425px] bg-primary-foreground rounded-xl fixed bottom-[5rem] right-[16px] overflow-auto shadow-xl border dark:border-none dark:bg-[#0B0B23] dark:border-interactive-border overflow-hidden'
      }
    >
