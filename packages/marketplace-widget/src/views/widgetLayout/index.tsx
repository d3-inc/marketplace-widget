...
const WidgetLayout = () => {
  ...
  if (!widgetConfig.tlds) {
    return (
      <div
        className={
          'flex flex-col w-[93svw] h-[90dvh] md:h-[560px] max-h:[90svh] md:max-h-[75svh] max-w-[400px] border bg-primary-foreground rounded-xl absolute bottom-16 right-0 overflow-auto shadow-xl dark:border dark:border-interactive-border'
        }
      >
  ...
  return (
    <div
      className={
        'flex flex-col w-[93svw] h-[90dvh] md:h-[560px] max-h:[90svh] md:max-h-[75svh] max-w-[400px] bg-primary-foreground rounded-xl absolute bottom-16 right-0 overflow-auto shadow-xl light:border light:bg-white dark:bg-[#0B0B23] dark:border-interactive-border'
      }
    >
